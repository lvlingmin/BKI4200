    ...
    class LisCommunication
    {
        ...
        public void connect()
        {
            ...
            try
            {
                ...
                thReceive.Start();
                        ...
                        frmMsgShow.MessageShow("Lis服务器无法连接" + "：" + e.Message);
                return;
            }
       ...
       /// <param name="str"></param>
        public void write(string str)
        {
            ...
            {
                        frmMessageShow frmMsgShow = new frmMessageShow();
                        frmMsgShow.MessageShow("发送消息失败" +e.Message+ "！");
            }
        ...
        public void AnalysDate(string message)
        {
            ...
            switch (DMSH[8])
            {
                ...
                case "QCK^Q02":
                      if (_errorinfo != "")
                          frmMsgShow.MessageShow("编号为" + CMessageParser.ConstrolID + "消息发送结果为:" + _errorinfo);
                        //LogFile.Write(DateTime.Now + "消息编号为" + CMessageParser.ConstrolID + "的反馈结果为：" + _errorinfo);
                    break;
                case "DSR^Q03":
                    if (_errorinfo != "")
