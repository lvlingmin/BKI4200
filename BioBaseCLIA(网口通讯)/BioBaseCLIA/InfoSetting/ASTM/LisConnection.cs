    ...
    class LisConnection
    {
        ...
        public void connect()
        {
            ...
            catch (Exception e)
            {
                ...
                frmMsgShow.MessageShow("信息提示","串口打开失败：" + e.Message);
                return;
            }
        ...
        public void write(string str)
        {
            ...
            {
                frmMessageShow frmMsgShow = new frmMessageShow();
                frmMsgShow.MessageShow("",LanguageManager.Instance.getLocaltionStr("SendMessageFail") + e.Message + "！");
            }
        }
        /// <summary>
        /// 通讯正在工作的标志
        ...
        public void CommDataReceived(Object sender, SerialDataReceivedEventArgs e)
        {
            ...
            {
                frmMessageShow frmMsgShow = new frmMessageShow();
                frmMsgShow.MessageShow("提示信息", "接收返回消息异常！具体原因：" + ex.Message);
            }
            if (ReceiveHandel != null)
