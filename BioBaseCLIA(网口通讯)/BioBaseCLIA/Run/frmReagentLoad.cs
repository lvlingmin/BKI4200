...
namespace BioBaseCLIA.Run
{
    public partial class frmReagentLoad : frmParent
    {
        ...
        {
            barCodeHook.Stop(); //lyq add 20190821
        ...
        private void ShowRgInfo(int start)
        {
            ...
            {
                srdReagent.RgName[int.Parse(dtRgInfo.Rows[i]["Postion"].ToString()) - 1] = dtRgInfo.Rows[i]["Postion"].ToString();
