    ...
    public partial class frmAddSample : frmSmallParent
    {
                ...
                for (int i = dtSampleInfo.Rows.Count - 1; i >= 0; i--)
                {
                    if (dtSampleInfo.Rows[i]["Status"].ToString() == "0")
                    {
                        ...
                        foreach (DataRow ddr in dr)
                        {
                            ...
                            int diuvol = 0;
                            if (!ddr["SampleType"].ToString().Contains("校准品"))
                            {
                                if (DilutionTimes > 0)
                ...
                for (int i = int.Parse(txtScanStartNo.Text.Trim()); i < int.Parse(txtScanEndNo.Text.Trim()) + 1; i++)
                {
                    ...
                    if (spCode != "")
                    {
                        ...
                        if (modelSp.Ward == null || modelSp.Ward == "")
                            modelSp.Ward = "";
                        if (cmbSpType.Text.Contains("校准品") || cmbSpType.Text.Contains("校准品") || cmbSpType.Text.Contains("定标液"))
                        {
                            modelSp.Emergency = 5;
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
                    ...
                    else
                    {
                        ...
                        if (Convert.ToInt32(dgvSampleList.SelectedRows[0].Cells["Status"].Value) == 0)
                        {
                            ...
                            foreach (DataRow ddr in dr)
                            {
                                ...
                                int DilutionTimes = int.Parse(ddr["DilutionTimes"].ToString());
                                int diuvol = 0;
                                if (!(ddr["SampleType"].ToString().Contains("校准品")|| ddr["SampleType"].ToString().Contains("校准品") || ddr["SampleType"].ToString().Contains("质控品")))
                                {
                                    if (DilutionTimes > 0)
                                        diuvol = GetSumDiuVol(ddr["ItemName"].ToString(), DilutionTimes);
                                }
            ...
            else if (((Button)sender).Text == "保存")
            {
                ...
                //    }
                //}
                if (cmbSpType.Text.Contains("校准品") && dtSampleInfo.Select("Status=0 and SampleType<>'" + "校准品" + "'").Length > 0 && frmWorkList.RunFlag == (int)RunFlagStart.IsRuning)
                {
                    frmMsg.MessageShow("温馨提示", "已经添加实验，请勿继续添加校准品!");
                    ...
                    if (ch.Checked)
                    {
                        for (int j = 0; j < dtItemInfo.Rows.Count; j++)
                        {
                            if (ch.Text == dtItemInfo.Rows[j]["ShortName"].ToString())
                            {
                                ...
                                int diuvol = 0;
                                //if (!cmbSpType.Text.Trim().Contains("校准品") && !cmbSpType.Text.Trim().Contains("质控品"))
                                if (!(cmbSpType.Text.Trim().Contains("校准品") || cmbSpType.Text.Trim().Contains("校准品") || cmbSpType.Text.Trim().Contains("质控品")))
                                {
                                    db = new DbHelperOleDb(0);
                                    DataTable dtProject = bllPj.GetList("ActiveStatus=1 AND ShortName='" + ShortName + "'").Tables[0];
                ...
                if (addOrModify == 0)
                {
                    ...
                    */
                    ...
                    if (modelSp.Diagnosis == null || modelSp.Diagnosis == "")
                        modelSp.Diagnosis = "";
                    if (cmbSpType.Text.Contains("校准品") || cmbSpType.Text.Contains("校准品") || cmbSpType.Text.Contains("定标液") || cmbSpType.Text.Contains("交叉污染"))
                    {
                        modelSp.Emergency = 5;
                        modelSp.RegentBatch = cmbBatch.SelectedItem.ToString();
                    }
                            ...
                            for (int j = 0; j < dtItemInfo.Rows.Count; j++)
                            {
                                if (ch.Text == dtItemInfo.Rows[j]["ShortName"].ToString())
                                {
                                    ...
                                    for (int ii = 0; ii < PointNum; ii++)
                                    {
                                        ...
                                        //if (cmbSpType.Text.Contains("校准品") || cmbSpType.Text.Contains("质控品"))
                                        if (cmbSpType.Text.Contains("校准品") || cmbSpType.Text.Contains("质控品")|| cmbSpType.Text.Contains("校准品"))
                                        {
                                            DiluteCount = "1";
                                            DiluteName = "1";
                                        }
                    ...
                    if (cmbSpType.Text == ("校准品"))
                    {
                        ...
                        for (int i2 = 1; i2 < PointNum + 1; i2++)
                        {
                            ...
                            {
                                case 1:
                                    modelSp.SampleType = "校准品A";
                                    break;
                                case 2:
                                    modelSp.SampleType = "校准品B";
                                    break;
                                case 3:
                                    modelSp.SampleType = "校准品C";
                                    break;
                                case 4:
                                    modelSp.SampleType = "校准品D";
                                    break;
                                case 5:
                                    modelSp.SampleType = "校准品E";
                                    break;
                                case 6:
                                    modelSp.SampleType = "校准品F";
                                    break;
                                case 7:
                                    modelSp.SampleType = "校准品G";
                                    break;
                                default:
                                    break;
                            }
                    ...
                    else if (cmbSpType.Text == ("交叉污染检测"))
                    {
                        ...
                        for (int i2 = 1; i2 < PointNum + 1; i2++)
                        {
                            ...
                            //{
                            //    case 1:
                            //        modelSp.SampleType = "交叉污染校准品A";
                            //        break;
                            //    case 2:
                            //        modelSp.SampleType = "交叉污染校准品B";
                            //        break;
                            //    case 3:
                            //        modelSp.SampleType = "交叉污染校准品C";
                            //        break;
                            //    case 4:
                            //        modelSp.SampleType = "交叉污染校准品D";
                            //        break;
                            //    case 5:
                            //        modelSp.SampleType = "交叉污染校准品E";
                            //        break;
                            //    case 6:
                            //        modelSp.SampleType = "交叉污染校准品F";
                            //        break;
                            //    default:
                            //        break;
                            //}
        ...
        bool ALlowAddStanard()
        {
            foreach (CheckBox ch in flpItemName.Controls)
            {
                if ((ch.Checked) && (cmbSpType.Text.ToString() == "校准品"))
                {
                    DbHelperOleDb db = new DbHelperOleDb(0);
                    ...
                    {
                        MessageBox.Show("剩余样本位数量不足，请勿继续添加校准品");
                        return false;
                    }
                }
            }
        ...
        private bool VerifyInfo()
        {
            ...
            //2018-11-16 zlx mod
            //if ((cmbSpType.Text.Contains("校准品") || cmbSpType.Text.Contains("校准品") || cmbSpType.Text.Contains("质控品") || cmbSpType.Text.Contains("定标液")) && itemNum > 1)
            if ((cmbSpType.Text.Contains("校准品") || cmbSpType.Text.Contains("校准品")/*||cmbSpType.Text.Contains("质控品")*/||
        ...
        {
            if (cmbSpType.SelectedIndex == 0 || cmbSpType.SelectedIndex == 1 || cmbSpType.SelectedIndex == 2 || cmbSpType.SelectedIndex == 3 || cmbSpType.SelectedIndex == 4)//2018-11-14 zlx mod
            {
        ...
        {
            //if (cmbSpType.Text.Contains("校准品") || cmbSpType.Text.Contains("校准品") || cmbSpType.Text.Contains("定标液") || cmbSpType.Text.Contains("质控品") || cmbSpType.Text.Contains("交叉污染"))
            if (cmbSpType.Text.Contains("校准品") || cmbSpType.Text.Contains("校准品") || cmbSpType.Text.Contains("定标液") /*|| cmbSpType.Text.Contains("质控品")*/ || cmbSpType.Text.Contains("交叉污染"))
            {
                cmbBatch.Items.Clear();
                ...
                if (ch.Checked)
                {
                    for (int j = 0; j < dtItemInfo.Rows.Count; j++)
                    {
                        if (ch.Text == dtItemInfo.Rows[j]["ShortName"].ToString())
                        {
                            ...
                            int diuvol = 0;
                            if (!(cmbmSpType.Text.Trim().Contains("校准品") || cmbmSpType.Text.Trim().Contains("质控品")))
                            {
                                DbHelperOleDb db = new DbHelperOleDb(0);
                                DataTable dtProject = bllPj.GetList("ActiveStatus=1 AND ShortName='" + ShortName + "'").Tables[0];
                                var dr = dtProject.Rows[0];
                    ...
                    if (Convert.ToInt32(dr[0]["Status"]) == 0)//[0]["Status"]
                    {
                        ...
                        foreach (DataRow ddr in drr)
                        {
                            ...
                            foreach (DataRow ddrRun in drRun)
                            {
                                ...
                                if (!(ddrRun["SampleType"].ToString().Contains("校准品")|| ddrRun["SampleType"].ToString().Contains("校准品")|| ddrRun["SampleType"].ToString().Contains("质控品")))
                                {
                                    if (DilutionTimes > 1)
