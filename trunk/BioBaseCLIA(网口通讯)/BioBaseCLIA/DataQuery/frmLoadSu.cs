    ...
    public partial class frmLoadSu : frmSmallParent
    {
       ...
       // frmMsgShow = new frmMessageShow();
        ...
        private void btnLoadSubstrate_Click(object sender, EventArgs e)
        {
            ...
            {
                frmMsgShow.MessageShow("底物装载", "剩余测数不应该大于总测数！");//add by y 20180509
                txtSubstrateLastTest.Focus();//add by y 20180510
                frmLoadSu_Load(null, null);//add by y 20180509
                return;//add by y 20180509
            }
            if (txtSubstrateCode.Text.Trim() == "")//add by y 20180510
            {
                txtSubstrateCode.Focus();//add by y 20180510
                frmMsgShow.MessageShow("底物装载", "请输入底物条码！");//add by y 20180510
